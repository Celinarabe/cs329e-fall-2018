...
-- ------------------------------------------------------------------------
\echo "*** ID, name, and GPA of students who applied in CS ***"

\echo "this is not right, why?"
...
\echo "this is also right, using subquery, with in"
...
-- ------------------------------------------------------------------------
\echo "*** GPA of students who applied in CS ***"
...
\echo "this is still not right, why?"
...
\echo "this is right, using subquery, with in"
...
-- ------------------------------------------------------------------------
\echo "*** ID of students who have applied in CS but not in EE ***"
...
\echo "this is right, using subquery, with in and not in"
...
-- ------------------------------------------------------------------------
\echo "*** colleges with another college in the same state ***"
...
select distinct R.cName, R.state
    ...
    on  (R.cName != S.cName) and -- does not allow where
        (R.state  = S.state);

\echo "using subquery, with exists"
...
\echo "using subquery, with group by and having"
...
\echo "using subquery, with not exists"
...
-- ------------------------------------------------------------------------
\echo "*** students with highest GPA ***"
...
\echo "this is also right, using subquery, with all"

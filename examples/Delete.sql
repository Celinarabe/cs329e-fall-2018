...
-- ------------------------------------------------------------------------
\echo "*** students who applied to two or more majors ***"
...
-- ------------------------------------------------------------------------
\echo "*** delete those students from Student ***"
...
-- ------------------------------------------------------------------------
\echo "*** Corresponding info in Apply will also be deleted  ***"
...
-- ------------------------------------------------------------------------
\echo "*** colleges without CS applications ***"
...
-- ------------------------------------------------------------------------
\echo "*** delete those colleges from College ***"

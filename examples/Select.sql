...
-- ------------------------------------------------------------------------
\echo "*** select * from Student where (GPA > 3.7) ***" 
select *
    from Student
    where (GPA > 3.7);

-- ------------------------------------------------------------------------
\echo "*** select * from Student where (GPA > 3.7) and (sizeHS < 1000) ***" 
select *
    from Student
    where (GPA > 3.7) and (sizeHS < 1000);

-- ------------------------------------------------------------------------
\echo "*** select * from Apply where (cName = 'Stanford') and (major = 'CS') ***" 
select *
    from Apply
    where (cName = 'Stanford') and (major = 'CS');

-- ------------------------------------------------------------------------
\echo "*** select sID, decision from Apply ***" 
select sID, decision
    from Apply;

-- ------------------------------------------------------------------------
\echo "*** select sID, sName from Student where (GPA > 3.7) ***" 
select sID, sName
    from Student
    where (GPA > 3.7);

-- ------------------------------------------------------------------------
\echo "*** select major, decision from Apply order by major ***" 
select major, decision
    from Apply
    order by major;

\echo "*** select distinct major, decision from Apply order by major ***" 

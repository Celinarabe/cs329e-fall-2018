...
\echo "*** select * from Student cross join Apply order by Student.sID;***"
select *
...
\echo "*** select * from Student inner join Apply using (sID);***"
select *
    from Student
    inner join Apply using (sID);

-- ------------------------------------------------------------------------
\echo "*** select * from Student inner join Apply using (sID) where (sizeHS > 1000) and (major = 'CS') and (decision = false) ***"
select *
    from Student
    inner join Apply using (sID)
    where (sizeHS > 1000) and (major = 'CS') and (decision = false);

\echo  "*** select sName, GPA from Student inner join Apply using (sID) where (sizeHS > 1000) and (major = 'CS') and (decision = false) ***"
select sName, GPA
    from Student
    inner join Apply using (sID)
    where (sizeHS > 1000) and (major = 'CS') and (decision = false);
...
-- ------------------------------------------------------------------------
\echo "*** select * from Student inner join Apply using (sID) ...... where (sizeHS > 500)   and (major = 'CS')  and (decision = true)  and (enrollment > 20000) ***"
select *
    from Student
        inner join Apply   using (sID)
...
\echo  "*** select sName, GPA from Student inner join Apply   using (sID) .... where (sizeHS > 500)   and (major = 'CS')  and (decision = true)  and (enrollment > 20000) ***"
select sName, GPA
    from Student
        inner join Apply   using (sID)
        inner join College using (cName)
